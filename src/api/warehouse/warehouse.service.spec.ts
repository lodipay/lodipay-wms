...
describe('WarehouseService', () => {
  ...
  beforeEach(async () => {
    ...
    whInventoryRepository = module.get<EntityRepository<WarehouseInventory>>(
  ...
  describe('warehouse inventory', () => {
    describe('assign warehouse inventory', () => {
      it('should throw inventory assign error', async () => {
        ...
        exception.toThrowError('Same inventory already assigned in warehouse');
      });
    ...
    it('return warehouse inventories list', async () => {
      ...
      expect(await service.getInventories(query)).toStrictEqual(paginatedDto);
    });
