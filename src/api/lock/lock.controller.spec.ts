...
describe('LockController', () => {
    ...
    it('create', async () => {
        ...
        jest.spyOn(lockService, 'create').mockImplementation(
            (dto: CreateLockDto) => {
    ...
    it('findAll', async () => {
        ...
        jest.spyOn(lockService, 'findAll').mockImplementation(() =>
    ...
    it('update', async () => {
        ...
        expect(await controller.update('1', new Lock('E-commerce'))).toBe(
            result,
        );
    });
